...
export default {
  list(search) {
    const url = `api/postionmanage/getPositionJT?orgId=28223&kid=${search.kid}&level=2&pageSzie=${search.pageSzie}&pageNum=${search.pageNum}`;
    return request.post(url, '');
  },
  getKeyResp() {
    return request.post('api/postionmanage/getKeyResp?mId=107', '');
  },
