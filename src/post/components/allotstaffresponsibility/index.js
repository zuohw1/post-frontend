...
import {
  Layout, Button, Tree, Menu, Input, Checkbox, Icon,
} from 'antd';
  ...
  return (
    <React.Fragment>
      <Content
        ...
        style={{
          background: '#fff', padding: '15px', margin: 0, minHeight: 280, height: '100%',
        }}
      >
        <div className="allot-staff-part">
          ...
          <div className="allot-staff-part-center">
            ...
            <div className="allot-staff-part-center-mask" style={{ display: maskDisplay }} />
          </div>
