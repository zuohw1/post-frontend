...
export default (props) => {
  ...
  const queryCols = [
    ...
    },
    {
      ...
      itemType: 'Select',
      required: false,
      list: [{ id: '0', title: '党群、纪检、工会' }, { id: '1', title: '管理' }, { id: '2', title: '国际业务销售' }, { id: '3', title: '采购管理' }, { id: '4', title: '集团客户销售' }, { id: '5', title: '综合行政与后勤' }],
    },
    {
    ...
    },
    {
      ...
      itemType: 'Checkbox',
      required: false,
      list: [{ label: '展示有效岗位', value: 'Y' }, { label: '展示无效岗位', value: 'N' }],
    },
    {
      itemName: '组织层级',
      itemKey: 'cRespName',
