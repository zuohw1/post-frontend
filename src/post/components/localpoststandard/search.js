...
import {
  Form, Row, Col, Input, Select, DatePicker, Button, Icon,
} from 'antd';
...
export default (props) => {
  ...
  {
    itemName: '', itemKey: 'cRespName', itemType: 'Checkbox', required: false, list: [{ label: '已设置本地基准岗位', value: 'prvpos' }, { label: '未设置本地基准岗位 ', value: 'noprvpos' }],
  },
  {
