      ...
      <div>
        <div className="check-post-content">
          <div className="check-post-content-line">
            ...
            <div className="check-post-content-line-right">所在部门：<Input style={{ width: 316,marginRight: 8 }} readonly="readonly" value="阿克苏地区分公司"/></div>
          </div>
          <div className="check-post-content-line">
            <div className="check-post-content-line-left">岗位序列：<Input style={{ width: 316,marginRight: 8 }} readonly="readonly" value="技术序列"/></div>
            <div className="check-post-content-line-right">对应职衔：<Input style={{ width: 316,marginRight: 8 }} readonly="readonly"/></div>
          </div>
          <div className="check-post-content-line">
            <div className="check-post-content-line-left">对应职位等级（等级带宽）：<Input style={{ width: 90,marginRight: 8 }} readonly="readonly" value="4"/>至<Input style={{ width: 90,marginRight: 8 }} readonly="readonly" value="6"/></div>
        ...
        <div className="post-seat" style={{ borderBottom: "1px solid #d9d9d9" }}>
          ...
          <table>
            ...
            <tr><td className="double-td"></td><td></td><td className="double-td"><Input className="input-border" readonly="readonly" /></td><td></td><td className="double-td"></td></tr>
        ...
        <div className="crux-duty" style={{ borderBottom: 0, borderRight: 0, }}>
          ...
          <div className="crux-duty-bottom">
              ...
              <div className="crux-duty-bottom-comments">
                <div className="crux-duty-one">{comment.id}</div>
