...
export default (props) => {
  const { form, actions, keyRespList, instructions,checkChecked1, checkChecked2, checkChecked3, checkChecked4 } = props;
          ...
          任职资格最低要求（包括但不限于以下选项）：
            ...
            <FormItem label="5、对口专业工作经验：">
                <div className="professional-experience">
                  <div className="professional-experience-one">
                    1、工作层面：
                    <Checkbox disabled></Checkbox>集团
                    <Checkbox disabled></Checkbox>省公司
                    <Checkbox disabled></Checkbox>市公司
                    <Checkbox disabled></Checkbox>不限层面
                  </div>
            ...
            <FormItem label="6、国家规定的职业（执业）资格证书及等级要求："> 
              <div className="profession-grade">
                工种：<Input style={{ width: 133, marginRight:16 }} readOnly="readonly" value={instructions.jobCateName}></Input>
                等级：<Input style={{ width: 133 }} readOnly="readonly" value={instructions.jobCateLevelName}></Input>
              </div>
            </FormItem>
            <FormItem label="7、专业技术职务："> 
              <div className="skills-duty">
                专业技术职务：<Input style={{ width: 133, marginRight:16 }} readOnly="readonly" value={instructions.postName}></Input>
                等级：<Input style={{ width: 133 }} readOnly="readonly" value={instructions.postLevelName}></Input>
              </div>
            </FormItem>
            <FormItem label="8、本企业专业资格："> 
              <div className="professional-qualifications">
                专业：<Input style={{ width: 133, marginRight:16 }} readOnly="readonly" value={instructions.proQualificationName}></Input>
                等级：<Input style={{ width: 133 }} readOnly="readonly" value={instructions.proQualificationLevelName}></Input>
              </div>
            </FormItem>
            <FormItem label="9、其他："> 
