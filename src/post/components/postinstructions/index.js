...
import { Layout, Breadcrumb, Collapse, TreeSelect, Select, Input, Button, DatePicker, } from 'antd';
					      ...
					      <div className="instructionsSearch">
									...
									<div className="instructionsSearch_1">
										...
										<span className="SearchContent SearchContent_4" style={noBorderRight}>
											...
											<Button type="primary" className="SearchContent_4_2">选择</Button>
											<Button className="SearchContent_4_3">置空</Button>
										</span>
									</div>
									<div className="instructionsSearch_1">
										<span className="SearchTitle">查询日期</span>
										<span className="SearchContent SearchContent_5">
											<DatePicker onChange={changeDate} />
										</span>
										<span className="SearchTitle">岗位名称</span>
										<span className="SearchContent SearchContent_6" style={noBorderRight}>
											<Input />
										</span>
									</div>
									<div className="instructionsSearch_1">
